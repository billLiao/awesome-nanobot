...
| [TinyClaw](https://github.com/warengonzaga/tinyclaw) | ⭐ 244 | The original Tiny Claw as your personal autonomous AI companion |
...
| [MultiUserClaw](https://github.com/johnson7788/MultiUserClaw) | ⭐ 237 | Multi-user support for OpenClaw/NanoBot |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) | ⭐ 475 | Multi-agent swarm coordination |
...
| [OSA](https://github.com/Miosa-osa/OSA) | ⭐ 34 | Optimal System Agent — maximizes signal extraction |
...
| [NanoMate](https://github.com/shenmintao/NanoMate) | ⭐ 98 | nanobot × SillyTavern, with Companion Mode |
| [ShibaClaw](https://github.com/RikyZ90/ShibaClaw) | ⭐ 98 | Self-hosted AI assistant framework — Multi-channel (Telegram, Discord, Slack), parallel agents, MCP support, WebUI with OAuth |
## Desktop & GUI
