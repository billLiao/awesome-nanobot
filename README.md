...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1256 | Build MCP Agents — Official nanobot with enhanced MCP support |
| [TinyClaw](https://github.com/warengonzaga/tinyclaw) | ⭐ 207 | The original Tiny Claw as your personal autonomous AI companion |
...
| [MultiUserClaw](https://github.com/johnson7788/MultiUserClaw) | ⭐ 179 | Multi-user support for OpenClaw/NanoBot |
...
| [nanobot-custom](https://github.com/deeeeeeeeap/nanobot-custom) | ⭐ 58 | Personal AI assistant based on nanobot — supports MiniMax, Gemini multi-model switching |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) | ⭐ 212 | Multi-agent swarm coordination |
...
| [OSA](https://github.com/Miosa-osa/OSA) | ⭐ 27 | Optimal System Agent — maximizes signal extraction |
| [ByeByeClaw](https://github.com/wanikua/byebyeclaw) | ⭐ 58 | One command to uninstall ALL Claw-family AI agents. Zero residual files |
| [NanoClaw](https://github.com/qwibitai/nanoclaw) | ⭐ 26591 | Lightweight alternative to OpenClaw — runs in containers, connects to WhatsApp, Telegram, Slack, Discord, Gmail |
...
| [nanobot-desktop](https://github.com/EvannZhongg/nanobot-desktop) | ⭐ 43 | Tauri + React desktop client |
...
| [maxclaw](https://github.com/Lichas/maxclaw) | ⭐ 202 | Ultra-Lightweight AI Assistant in Go |
...
| [nano-claw](https://github.com/hustcc/nano-claw) | ⭐ 52 | 🦞 Claw is a personal AI assistant you run on your own devices, but nano (TypeScript) |
