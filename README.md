...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1306 | Build MCP Agents — Official nanobot with enhanced MCP support |
| [TinyClaw](https://github.com/warengonzaga/tinyclaw) | ⭐ 240 | The original Tiny Claw as your personal autonomous AI companion |
| [OpenLegion](https://github.com/openlegion-ai/openlegion) | ⭐ 91 | Secure autonomous AI agent fleet platform — Docker-isolated, multi-provider |
| [MultiUserClaw](https://github.com/johnson7788/MultiUserClaw) | ⭐ 231 | Multi-user support for OpenClaw/NanoBot |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) | ⭐ 442 | Multi-agent swarm coordination |
...
| [OSA](https://github.com/Miosa-osa/OSA) | ⭐ 32 | Optimal System Agent — maximizes signal extraction |
| [ByeByeClaw](https://github.com/wanikua/byebyeclaw) | ⭐ 70 | One command to uninstall ALL Claw-family AI agents. Zero residual files |
| [NanoClaw](https://github.com/qwibitai/nanoclaw) | ⭐ 28538 | Lightweight alternative to OpenClaw — runs in containers, connects to WhatsApp, Telegram, Slack, Discord, Gmail |
...
| [ShibaClaw](https://github.com/RikyZ90/ShibaClaw) | ⭐ 45 | Self-hosted AI assistant framework — Multi-channel (Telegram, Discord, Slack), parallel agents, MCP support, WebUI with OAuth |
## Desktop & GUI
...
| [nanobot-desktop](https://github.com/EvannZhongg/nanobot-desktop) | ⭐ 48 | Tauri + React desktop client |
...
| [maxclaw](https://github.com/Lichas/maxclaw) | ⭐ 218 | Ultra-Lightweight AI Assistant in Go |
...
| [FemtoBot](https://github.com/rafnixg/femtobot) | ⭐ 2 | It is an educational demonstration of a conversational agent architecture inspired by the "nanobot" project |
