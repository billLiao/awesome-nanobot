...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1281 | Build MCP Agents — Official nanobot with enhanced MCP support |
| [TinyClaw](https://github.com/warengonzaga/tinyclaw) | ⭐ 225 | The original Tiny Claw as your personal autonomous AI companion |
| [OpenLegion](https://github.com/openlegion-ai/openlegion) | ⭐ 86 | Secure autonomous AI agent fleet platform — Docker-isolated, multi-provider |
| [MultiUserClaw](https://github.com/johnson7788/MultiUserClaw) | ⭐ 205 | Multi-user support for OpenClaw/NanoBot |
...
| [nanobot-custom](https://github.com/deeeeeeeeap/nanobot-custom) | ⭐ 61 | Personal AI assistant based on nanobot — supports MiniMax, Gemini multi-model switching |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) | ⭐ 372 | Multi-agent swarm coordination |
...
| [OSA](https://github.com/Miosa-osa/OSA) | ⭐ 28 | Optimal System Agent — maximizes signal extraction |
| [ByeByeClaw](https://github.com/wanikua/byebyeclaw) | ⭐ 70 | One command to uninstall ALL Claw-family AI agents. Zero residual files |
| [NanoClaw](https://github.com/qwibitai/nanoclaw) | ⭐ 27535 | Lightweight alternative to OpenClaw — runs in containers, connects to WhatsApp, Telegram, Slack, Discord, Gmail |
...
| [ShibaClaw](https://github.com/RikyZ90/ShibaClaw) | ⭐ 32 | Self-hosted AI assistant framework — Multi-channel (Telegram, Discord, Slack), parallel agents, MCP support, WebUI with OAuth |
## Desktop & GUI
...
| [nanobot-desktop](https://github.com/EvannZhongg/nanobot-desktop) | ⭐ 46 | Tauri + React desktop client |
...
| [maxclaw](https://github.com/Lichas/maxclaw) | ⭐ 212 | Ultra-Lightweight AI Assistant in Go |
...
| [nano-claw](https://github.com/hustcc/nano-claw) | ⭐ 57 | 🦞 Claw is a personal AI assistant you run on your own devices, but nano (TypeScript) |
