...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1270 | Build MCP Agents — Official nanobot with enhanced MCP support |
| [TinyClaw](https://github.com/warengonzaga/tinyclaw) | ⭐ 214 | The original Tiny Claw as your personal autonomous AI companion |
| [OpenLegion](https://github.com/openlegion-ai/openlegion) | ⭐ 83 | Secure autonomous AI agent fleet platform — Docker-isolated, multi-provider |
| [MultiUserClaw](https://github.com/johnson7788/MultiUserClaw) | ⭐ 198 | Multi-user support for OpenClaw/NanoBot |
...
| [nanobot-custom](https://github.com/deeeeeeeeap/nanobot-custom) | ⭐ 60 | Personal AI assistant based on nanobot — supports MiniMax, Gemini multi-model switching |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) | ⭐ 322 | Multi-agent swarm coordination |
...
| [OSA](https://github.com/Miosa-osa/OSA) | ⭐ 26 | Optimal System Agent — maximizes signal extraction |
| [ByeByeClaw](https://github.com/wanikua/byebyeclaw) | ⭐ 62 | One command to uninstall ALL Claw-family AI agents. Zero residual files |
| [NanoClaw](https://github.com/qwibitai/nanoclaw) | ⭐ 27177 | Lightweight alternative to OpenClaw — runs in containers, connects to WhatsApp, Telegram, Slack, Discord, Gmail |
...
| [ShibaClaw](https://github.com/RikyZ90/ShibaClaw) | ⭐ 27 | Self-hosted AI assistant framework — Multi-channel (Telegram, Discord, Slack), parallel agents, MCP support, WebUI with OAuth |
## Desktop & GUI

| Project | Stars | Description |
|---------|-------|-------------|
| [nanoboard](https://github.com/Freakz3z/nanoboard) | ⭐ 0 | Tauri-based management dashboard |
| [nanoBot-ui](https://github.com/qq695500710-ui/nanoBot-ui) | ⭐ 182 | Plug-and-play nanobot for Windows 10+ |
| [nanobot-desktop](https://github.com/EvannZhongg/nanobot-desktop) | ⭐ 45 | Tauri + React desktop client |
...
| [maxclaw](https://github.com/Lichas/maxclaw) | ⭐ 206 | Ultra-Lightweight AI Assistant in Go |
...
| [nano-claw](https://github.com/hustcc/nano-claw) | ⭐ 55 | 🦞 Claw is a personal AI assistant you run on your own devices, but nano (TypeScript) |
