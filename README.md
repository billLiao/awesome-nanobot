...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1183 | Build MCP Agents — Official nanobot with enhanced MCP support |
...
| [nanobot-webui](https://github.com/codemo1991/nanobot-webui) | ⭐ 18 | Web UI with visual configuration & knowledge management |
## Language Ports
