...
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1208 | Build MCP Agents — Official nanobot with enhanced MCP support |
...
| [nanobot-webgui](https://github.com/lucmuss/nanobot-webgui) | ⭐ 12 | Production-focused web GUI fork with setup wizard, MCP management, chat, memory, and admin controls |
