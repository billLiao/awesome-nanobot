...
| 项目 | Stars | 描述 |
|---------|-------|-------------|
| [nanobot](https://github.com/nanobot-ai/nanobot) | ⭐ 1207 | 构建 MCP Agents — 官方 nanobot，增强的 MCP 支持 |
...
| [nanobot-webgui](https://github.com/lucmuss/nanobot-webgui) | ⭐ 11 | 生产级 Web GUI 分支，包含设置向导、MCP 管理、聊天、记忆和管理控制 |
